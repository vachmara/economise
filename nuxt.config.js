...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: "Adieu Uber Eats et les pizzas ! Découvrez Econonmise, l'outil qui génère des recettes à partir des ingrédients que vous avez chez vous. En utilisant l'IA, Économise génère des recettes basées sur les ingrédients que vous avez déjà dans votre frigo et votre placard. Plus besoin de gaspiller de l'argent sur des ingrédients supplémentaires ou de laisser des aliments se gâter parce que vous ne savez pas quoi en faire." },
      ...
      { name: 'og:description', content: "Adieu Uber Eats et les pizzas ! Découvrez Econonmise, l'outil qui génère des recettes à partir des ingrédients que vous avez chez vous." },
